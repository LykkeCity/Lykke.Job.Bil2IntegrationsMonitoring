...
using Lykke.Job.Lykke.Job.Bil2IntegrationsMonitoring.IncomingMessages;
using Lykke.RabbitMqBroker;
using Lykke.RabbitMqBroker.Subscriber;
using System;
using System.Threading.Tasks;

namespace Lykke.Job.Lykke.Job.Bil2IntegrationsMonitoring.RabbitSubscribers
{
    public class MyRabbitSubscriber : IStartable, IStopable
    {
        ...
        public void Start()
        {
            ...
            var settings = RabbitMqSubscriptionSettings
                .CreateForSubscriber(_connectionString, _exchangeName, "lykke.job.bil2integrationsmonitoringjob");
